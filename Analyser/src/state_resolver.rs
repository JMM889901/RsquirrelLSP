//Previously in analysis_common, an extremely overcomplicated implementation of Quine McCluskey
                ...
                for otherset in newsets[idx+1..].iter(){
                    ...
                    match result{
                        ...
                        MergeResults::CancelledElem(self_new, other_new) => {
                            ...
                            cancel_results.push(self_new);
                            cancel_results.push(other_new);
